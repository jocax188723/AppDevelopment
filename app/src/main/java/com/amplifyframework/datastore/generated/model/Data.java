...
/** This is an auto generated class representing the Data type in your schema. */
@SuppressWarnings("all")
@ModelConfig(pluralName = "Data", authRules = {
  @AuthRule(allow = AuthStrategy.PUBLIC, operations = { ModelOperation.CREATE, ModelOperation.UPDATE, ModelOperation.DELETE, ModelOperation.READ })
})
public final class Data implements Model {
  public static final QueryField ID = field("Data", "id");
  public static final QueryField COMPLETED_AT = field("Data", "completedAt");
  public static final QueryField DATA = field("Data", "Data");
  ...
  private Data(String id, Temporal.DateTime completedAt, List<Double> Data) {
    this.id = id;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      Data data = (Data) obj;
      return ObjectsCompat.equals(getId(), data.getId()) &&
              ObjectsCompat.equals(getCompletedAt(), data.getCompletedAt()) &&
              ObjectsCompat.equals(getData(), data.getData()) &&
              ObjectsCompat.equals(getCreatedAt(), data.getCreatedAt()) &&
              ObjectsCompat.equals(getUpdatedAt(), data.getUpdatedAt());
      }
  }
   ...
   */
  public static Data justId(String id) {
    return new Data(
      id,
      null,
      null
